...
function Home() {
    ...
    const offer = [
        ...
        },
        {
            id: 20002,
            offerimage:
                "https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2023/7/30/e8aea330-10cd-4778-91ab-da9678161ec11690739860849-PB-Banner_Wishlist-Now.jpg",
        },
        {
            id: 20003,
            offerimage:
    ...
    return (
        <>
            <Carousel
                ...
                onSlide={(slideIndex) =>
                    console.log(`Active Slide: ${slideIndex}`)
                }
            >
                {offer.map((items) => (
